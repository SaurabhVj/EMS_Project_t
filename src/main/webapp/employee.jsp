...
<body class="center">
    <form method="POST" action='/employee-management/manage?action=save' name="frmEmp">
        ...
        Phone Number : <input type="text" name="phone" value="<c:out value="${user.phone}" />" /><br />
		Date of Birth : <input type="text" name="Date of Birth" value="<c:out value="${user.phone}" />" /><br />        
        Employee Id : <input type="text" name="userid" value="<c:out value="${user.userid}" />" /><br />
